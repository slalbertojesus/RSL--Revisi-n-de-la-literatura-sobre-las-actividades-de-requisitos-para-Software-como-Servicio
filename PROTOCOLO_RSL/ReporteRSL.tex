...
\usepackage[backend=biber, maxbibnames=6, style=numeric]{biblatex}
...
En el segundo estudio secundario \cite{existente2} se realizó un análisis de metodologías, modelos o herramientas para abordar requisitos en sistemas en la nube, el estudio 
