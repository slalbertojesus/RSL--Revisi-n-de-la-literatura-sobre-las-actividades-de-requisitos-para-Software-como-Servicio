...
\multicolumn{2}{|c|}{Datos generales} \\
  \hline
    ...
    \hline
    Actividades utilizadas para elicitación& \\
    \hline
    Retos identificados en las técnicas de elicitación& \\
    \hline
    Análisis de la información \\
    \hline
    Técnicas de elicitación & \\
    \hline
    Técnicas  de análisis identificadas& \\
    \hline
    Técnicas  utilizadas para validar requisitos & \\
    \hline
    Actividades & \\
    \hline
