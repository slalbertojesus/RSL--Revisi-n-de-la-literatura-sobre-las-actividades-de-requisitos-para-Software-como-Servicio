...
metodologías y estrategias tradicionales no cubren las necesidades de un \emph{Saas}. por esto es necesario adecuar el conocimiento 
...
productos con modelo \emph{software as a service}, en especial en sectores enfocados a educación en línea, cuidado de la salud y \emph{e-commerce} \cite{value:online} .
Esto se ha provocado debido a que existen negocios dipuestos a utilizar tecnología como un medio para reducir costos, ofrecer mejores servicios 
sin utilizar recursos internos. Sim embargo, para aquellos interesados en desarrollar un \emph{software} como servicio.





Una de las tendencias actuales, establecida por el virus SARS-CoV-2 (COVID-19)
el modelo de distribución \emph{Software as a Service}, 
